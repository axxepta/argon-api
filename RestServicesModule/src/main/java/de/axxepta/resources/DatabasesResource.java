...
public class DatabasesResource{
	...
	@Operation(summary = "Show databases", description = "Show existing database on BaseX server", method = "GET", operationId = "#3_1")
	...
	@Operation(summary = "Show database infos", description = "Show infos about database existing on BaseX server", method = "GET", operationId = "#3_2")
	...
	@Operation(summary = "Create database", description = "Create a database to which an initial file may be added", method = "POST", operationId = "#3_3")
